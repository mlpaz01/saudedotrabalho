...
function mapRole(value: unknown): string {
  const aliases: Record<string, string> = {
    ...
    qualidade: "qualidade",
    sgq: "gestor_qualidade",
    "gestao da qualidade": "gestor_qualidade",
    "gestão da qualidade": "gestor_qualidade",
    "gestor da qualidade": "gestor_qualidade",
    "gestora da qualidade": "gestor_qualidade",
    "gestor sgq": "gestor_qualidade",
    "responsavel sgq": "gestor_qualidade",
    "responsável sgq": "gestor_qualidade",
    rh: "rh",
    "recursos humanos": "rh",
    "perfil rh": "rh",
    admin: "admin",
